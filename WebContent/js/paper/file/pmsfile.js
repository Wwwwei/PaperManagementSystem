 ...
 *
 */
//var FILES = [0, 0, 0, 0, 0];//0:表示未上传,1:表示上传,数组位数表示文件类型  文件类型 1:作者信息页;2:论文全页;3:论文/期刊封面;4:论文/期刊封底;5:论文检索证明(国内类型1、2、3、4，国外类型2、5)
function changefile() {
...
$("#file-1").fileinput({
    language: 'zh',
    uploadUrl: 'paper_proxy/upload.do?fileType=1', // you must set a valid URL here else you will get an error
...
$("#file-2").fileinput({
    language: 'zh',
    uploadUrl: 'paper_proxy/upload.do?fileType=2', // you must set a valid URL here else you will get an error
    allowedFileExtensions: ['pdf', 'doc', 'docx'],
    overwriteInitial: false,
    maxFileSize: 1000,
    maxFilesNum: 1,
...
$("#file-3").fileinput({
    language: 'zh',
    uploadUrl: 'paper_proxy/upload.do?fileType=3', // you must set a valid URL here else you will get an error
    allowedFileExtensions: ['pdf', 'doc', 'docx'],
    overwriteInitial: false,
    maxFileSize: 1000,
    maxFilesNum: 1,
...
$("#file-4").fileinput({
    language: 'zh',
    uploadUrl: 'paper_proxy/upload.do?fileType=4', // you must set a valid URL here else you will get an error
    allowedFileExtensions: ['pdf', 'doc', 'docx'],
    overwriteInitial: false,
    maxFileSize: 1000,
    maxFilesNum: 1,
...
$("#file-6").fileinput({
    language: 'zh',
    uploadUrl: 'paper_proxy/upload.do?fileType=5', // you must set a valid URL here else you will get an error
    allowedFileExtensions: ['pdf', 'doc', 'docx'],
    overwriteInitial: false,
    maxFileSize: 1000,
    maxFilesNum: 1,
