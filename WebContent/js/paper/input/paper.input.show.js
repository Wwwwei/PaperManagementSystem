			...
			.ajax({
				...
				success : function(data, stats) {
					if (stats == "success") {
						...
						case 0:addText+= "<dd>已录用</dd></dl></div>";time_name="录用时间";break;
						case 1:addText+= "<dd>已发表</dd></dl></div>";time_name="发表时间";break;
						}		
						...
						addText +="<div class='panel panel-primary'>" 
							...
							case 0:addText+="期刊";list="收起期刊列表";conj="期刊";break;
							case 1:addText+="会议";list="收起会议列表";conj="会议";break;
							}
							addText +="</td>"
				...
				success : function(data, stats) {
					if (stats == "success") {
						...
						for ( var i in authorResult) {
							...
							case 1:addText+="<td>本校</td>";break;
							case 2:addText+="<td>外校</td>";break;
							case 3:addText+="<td>研究生</td>";break;
							case 4:addText+="<td>本科生 </td>";break;
							}
