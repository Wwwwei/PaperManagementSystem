...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4"><input type="radio" name="paper_type" value="0" checked onclick="changefile()">&nbsp;&nbsp;国内论文</div>
			<div class="col-md-4"><input type="radio" name="paper_type" value="1" onclick="changefile()">&nbsp;&nbsp;国外论文</div>
			...
			<div class="col-md-12">
				<div class="alert alert-warning">
					<table>
						...
						<tr>
							<td>更新时必须重复上传文件，上传的文件将替换掉原来的文件。</td>
						</tr>
					</table>
				</div>
			</div>
			...
			<div class="col-md-12" id="china2">
				<ul class="nav nav-tabs nav-justified" role="tablist">
				  <li role="presentation" class="active" id="p1"><a href="#page1" role="tab" data-toggle="tab">论文/期刊封面</a></li>
				...
				<div class="tab-content">
				  ...
				  <div role="tabpanel" class="tab-pane" id="page3">
				    <form enctype="multipart/form-data">
 						<div class="form-group">
							<input id="file-3" type="file" multiple class="file" data-overwrite-initial="false" data-min-file-count="1">
						</div>
					</form>
				  ...
				  <div role="tabpanel" class="tab-pane" id="page4">
				  	<form enctype="multipart/form-data">
 						<div class="form-group">
							<input id="file-4" type="file" multiple class="file" data-overwrite-initial="false" data-min-file-count="1">
						</div>
					</form>
			...
			<div class="col-md-12 hidden" id="us2">
				...
				<div class="tab-content">
				  <div role="tabpanel" class="tab-pane active" id="paperwhole2">
				    	<form enctype="multipart/form-data">
 						<div class="form-group">
							<input id="file-5" type="file" multiple class="file" data-overwrite-initial="false" data-min-file-count="1">
						</div>
						</form>
				  ...
				  <div role="tabpanel" class="tab-pane" id="profile2">
				  	<form enctype="multipart/form-data">
 						<div class="form-group">
							<input id="file-6" type="file" multiple class="file" data-overwrite-initial="false" data-min-file-count="1">
						</div>
					</form>
			...
			<div class="col-md-6">
				<button class="btn btn-block btn-primary">上一步</button>
			</div>
			<div class="col-md-6">
