					...
					<c:forEach var="paper" begin="0" end="10" step="1"
						...
						<tr>
							...
							<td class="text-overflow"><a
								href="teacher/findTeacherInfo.do?teacher_id=${paper.paper_teacher.teacher_id}">${paper.paper_name}</a></td>
							<td><a
								href="findTeacherInfo.do?teacher_id='${paper.paper_teacher.teacher_id}'">${paper.paper_teacher.teacher_name}</a></td>
