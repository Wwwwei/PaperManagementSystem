...
<jsp:include page="header.jsp">
    <jsp:param value="2" name="location"/>
</jsp:include>
<!--导航条结束-->
<div class="jumbotron">
    <h1 style="font-size: 45px;">已提交的成果</h1>
</div>
<!--查询结果显示开始-->
<div class="container">
            ...
            <c:forEach var="paper" begin="0" end="10" step="1"
                ...
                <tr>
                    ...
                    <c:if test="${paper.paper_status == 0}">
                        <td>
                            <a href="teacher/modifyPaper.do?paper_id=${paper.paper_id }&teacher_no=${teacher.teacher_no}">修改</a><br>
                        </td>
                    </c:if>
                    <c:if test="${paper.paper_status == 1}">
                        <td>
                            <a href="teacher/modifyPaper.do?paper_id=${paper.paper_id }&teacher_no=${teacher.teacher_no}">查看</a><br>
                        </td>
                    </c:if>
                        <%-- 						<td><ahref="teacher/modifyPaper.do?paper_id=${paper.paper_id }">修改</a><br></td> --%>
                    <!-- 						<td><a -->
