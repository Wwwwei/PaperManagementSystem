...
//		List<AuthorProxy> authors = new ArrayList();
	...
	public boolean check(@RequestParam("paper_name") String paperproxy_name, HttpServletRequest request) {
	...
	@ResponseBody
	@RequestMapping(value = "/paper_proxy/test2", method = RequestMethod.GET)
	public ModelAndView test2() {
		Map<String, String> model = new HashMap<String, String>();
		model.put("paperproxy_id", "160");
		return new ModelAndView("paperproxy/paperproxy_modify", model);
	}
}
